...
func (in *ResourceClaimSpec) DeepCopyInto(out *ResourceClaimSpec) {
	*out = *in
	if in.ResourceClassName != nil {
		in, out := &in.ResourceClassName, &out.ResourceClassName
		*out = new(string)
		**out = **in
	}
	...
	if in.AllocationMode != nil {
		in, out := &in.AllocationMode, &out.AllocationMode
		*out = new(AllocationMode)
		**out = **in
	}
	return
}
...
func (in *ResourceClaimStatus) DeepCopyInto(out *ResourceClaimStatus) {
	*out = *in
	if in.DriverName != nil {
		in, out := &in.DriverName, &out.DriverName
		*out = new(string)
		**out = **in
	}
	...
	if in.DeallocationRequested != nil {
		in, out := &in.DeallocationRequested, &out.DeallocationRequested
		*out = new(bool)
		**out = **in
	}
	return
